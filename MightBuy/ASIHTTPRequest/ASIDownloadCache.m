...
- (void)updateExpiryForRequest:(ASIHTTPRequest *)request maxAge:(NSTimeInterval)maxAge
{
	...
	[cachedHeaders setObject:@([expires timeIntervalSince1970]) forKey:@"X-ASIHTTPRequest-Expires"];
...
- (void)storeResponseForRequest:(ASIHTTPRequest *)request maxAge:(NSTimeInterval)maxAge
{
	...
	NSDate *expires = [self expiryDateForRequest:request maxAge:maxAge];
	if (expires) {
		[responseHeaders setObject:@([expires timeIntervalSince1970]) forKey:@"X-ASIHTTPRequest-Expires"];
	}
	...
	[responseHeaders setObject:@(statusCode) forKey:@"X-ASIHTTPRequest-Response-Status-Code"];
