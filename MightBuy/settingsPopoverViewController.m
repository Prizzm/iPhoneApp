...
- (void)viewDidLoad
{
    ...
    [[self tableView] setFrame:CGRectMake(0, 0, 320, 96)];
...
{
    [ListHelper deleteUsersWithContext:[[CoreDataController sharedManager] managedObjectContext]];
    [ListHelper deleteTopicsWithContext:[[CoreDataController sharedManager] managedObjectContext]];
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    [defaults setObject:nil forKey:@"auth_token"];
    [[NSUserDefaults standardUserDefaults] synchronize];
    [(TabBarViewController *)[parent tabBarController] performSegueWithIdentifier:@"gobacktologin" sender:self];
